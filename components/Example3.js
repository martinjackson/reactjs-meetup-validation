  ...
  render(){
    ...
    return <div>
            ...
            <div onChange={this.handleChange} >
              From: <input       name="from"     style={vs('from')}     value={this.state.from} placeholder="MM/DD/YYYY" />
              To: <input         name="to"       style={vs('to')}       value={this.state.to}   placeholder="MM/DD/YYYY" />
              OTB: <MbsSelectOTB name="otb"      style={vs('otb')}      value={this.state.otb} />                       <br />
              Subjects: <input   name="subjects" style={vs('subjects')} value={this.state.subjects} />                  <br />
              Cost: <input       name="cost"     style={vs('cost')}     value={this.state.cost} />
              Quantity: <input   name="qnt"      style={vs('qnt')}      value={this.state.qnt} />                       <br />
